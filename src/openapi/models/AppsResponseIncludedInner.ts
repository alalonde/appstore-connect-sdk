 ...
 * @export
 */
export type AppsResponseIncludedInner = AppClip | AppCustomProductPage | AppEncryptionDeclaration | AppEvent | AppInfo | AppPreOrder | AppPrice | AppStoreVersion | AppStoreVersionExperimentV2 | BetaAppLocalization | BetaAppReviewDetail | BetaGroup | BetaLicenseAgreement | Build | CiProduct | EndUserLicenseAgreement | GameCenterDetail | GameCenterEnabledVersion | InAppPurchase | InAppPurchaseV2 | PrereleaseVersion | PromotedPurchase | ReviewSubmission | SubscriptionGracePeriod | SubscriptionGroup | Territory;
