...
import type {
  ...
  BuildBetaDetailWithoutIncludesResponse,
...
import {
    ...
    BuildBetaDetailWithoutIncludesResponseFromJSON,
    BuildBetaDetailWithoutIncludesResponseToJSON,
...
export class BuildsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async buildsBuildBetaDetailGetToOneRelatedRaw(requestParameters: BuildsBuildBetaDetailGetToOneRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BuildBetaDetailWithoutIncludesResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => BuildBetaDetailWithoutIncludesResponseFromJSON(jsonValue));
    }

    /**
     */
    async buildsBuildBetaDetailGetToOneRelated(requestParameters: BuildsBuildBetaDetailGetToOneRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BuildBetaDetailWithoutIncludesResponse> {
