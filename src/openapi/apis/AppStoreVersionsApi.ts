...
import {
    ...
    AppStoreVersionLocalizationsWithoutIncludesResponseFromJSON,
    AppStoreVersionLocalizationsWithoutIncludesResponseToJSON,
...
export class AppStoreVersionsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async appStoreVersionsAppStoreVersionLocalizationsGetToManyRelatedRaw(requestParameters: AppStoreVersionsAppStoreVersionLocalizationsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AppStoreVersionLocalizationsWithoutIncludesResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => AppStoreVersionLocalizationsWithoutIncludesResponseFromJSON(jsonValue));
    }

    /**
     */
    async appStoreVersionsAppStoreVersionLocalizationsGetToManyRelated(requestParameters: AppStoreVersionsAppStoreVersionLocalizationsGetToManyRelatedRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AppStoreVersionLocalizationsWithoutIncludesResponse> {
